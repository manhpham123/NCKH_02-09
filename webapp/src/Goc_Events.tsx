...
export function Events() {
  ...
  function openEventById(id: string) {
    //window.alert(`Navigating to event with ID: ${id} from ${location.pathname}`);
    navigate(`/event/${id}`, {
      state: {
            ...
            <div class={"row align-items-center"}>
              ...
              <div class={"col-auto"}>
                <select
                  ...
                  onchange={(e) => {
                    handleNavigation(`/event_type=${e.currentTarget.value}`);
                          ...
                          return (
                            <>
                              <tr
                                onclick={() =>
                                { 
                                  //const newUrl = `/event/${event._id}`;  // URL mới sẽ được gửi đến dịch vụ cha 
                                  //handleNavigationHai(newUrl);  // Gọi hàm để thay đổi URL và gửi thông điệp đến dịch vụ cha
                                  openEventById(event._id)
